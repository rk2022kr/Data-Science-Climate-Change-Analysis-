# -*- coding: utf-8 -*-
"""
Created on Sun Dec 11 14:20:52 2022
...
#Defining function to fetch the data for CO2 emissions (kt) from the master data frame
def fetch_process():
    ...
    processed_data = pd.DataFrame(initial_data, columns = ['Year','Country','CO2 emissions (kt)'])
