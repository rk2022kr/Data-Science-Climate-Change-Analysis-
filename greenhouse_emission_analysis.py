# -*- coding: utf-8 -*-
"""
Created on Sun Dec 11 14:17:14 2022
...
#Defining function to fetch the data for Total greenhouse gas emissions (% change from 1990) from the master data frame
def fetch_process():
    ...
    processed_data = pd.DataFrame(initial_data, columns = ['Year','Country','Total greenhouse gas emissions (% change from 1990)'])
...
for year in years_choosen:
    data4.append(float(fetch_data['Total greenhouse gas emissions (% change from 1990)'][(fetch_data['Country']=='China') & (fetch_data['Year']==year)].to_string(index=False)))

for year in years_choosen:
    data5.append(float(fetch_data['Total greenhouse gas emissions (% change from 1990)'][(fetch_data['Country']=='Ecuador') & (fetch_data['Year']==year)].to_string(index=False)))

for year in years_choosen:
    data6.append(float(fetch_data['Total greenhouse gas emissions (% change from 1990)'][(fetch_data['Country']=='France') & (fetch_data['Year']==year)].to_string(index=False)))

for year in years_choosen:
    data7.append(float(fetch_data['Total greenhouse gas emissions (% change from 1990)'][(fetch_data['Country']=='India') & (fetch_data['Year']==year)].to_string(index=False)))

for year in years_choosen:
    data8.append(float(fetch_data['Total greenhouse gas emissions (% change from 1990)'][(fetch_data['Country']=='Nigeria') & (fetch_data['Year']==year)].to_string(index=False)))

for year in years_choosen:
    data9.append(float(fetch_data['Total greenhouse gas emissions (% change from 1990)'][(fetch_data['Country']=='South Africa') & (fetch_data['Year']==year)].to_string(index=False)))

for year in years_choosen:
    data10.append(float(fetch_data['Total greenhouse gas emissions (% change from 1990)'][(fetch_data['Country']=='Sweden') & (fetch_data['Year']==year)].to_string(index=False)))

for year in years_choosen:
    data11.append(float(fetch_data['Total greenhouse gas emissions (% change from 1990)'][(fetch_data['Country']=='United Kingdom') & (fetch_data['Year']==year)].to_string(index=False)))

for year in years_choosen:
    data12.append(float(fetch_data['Total greenhouse gas emissions (% change from 1990)'][(fetch_data['Country']=='United States') & (fetch_data['Year']==year)].to_string(index=False)))
