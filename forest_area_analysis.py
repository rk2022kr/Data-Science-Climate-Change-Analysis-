# -*- coding: utf-8 -*-
"""
Created on Sun Dec 11 14:21:49 2022
...
#Defining function to fetch the data for Forest area (% of land area) from the master data frame
def fetch_process():
    ...
    processed_data = pd.DataFrame(initial_data, columns = ['Year','Country','Forest area (% of land area)'])
...
for year in years_choosen:
    data4.append(float(fetch_data['Forest area (% of land area)'][(fetch_data['Country']=='China') & (fetch_data['Year']==year)].to_string(index=False)))

for year in years_choosen:
    data5.append(float(fetch_data['Forest area (% of land area)'][(fetch_data['Country']=='Ecuador') & (fetch_data['Year']==year)].to_string(index=False)))

for year in years_choosen:
    data6.append(float(fetch_data['Forest area (% of land area)'][(fetch_data['Country']=='France') & (fetch_data['Year']==year)].to_string(index=False)))

for year in years_choosen:
    data7.append(float(fetch_data['Forest area (% of land area)'][(fetch_data['Country']=='India') & (fetch_data['Year']==year)].to_string(index=False)))

for year in years_choosen:
    data8.append(float(fetch_data['Forest area (% of land area)'][(fetch_data['Country']=='Nigeria') & (fetch_data['Year']==year)].to_string(index=False)))

for year in years_choosen:
    data9.append(float(fetch_data['Forest area (% of land area)'][(fetch_data['Country']=='South Africa') & (fetch_data['Year']==year)].to_string(index=False)))

for year in years_choosen:
    data10.append(float(fetch_data['Forest area (% of land area)'][(fetch_data['Country']=='Sweden') & (fetch_data['Year']==year)].to_string(index=False)))

for year in years_choosen:
    data11.append(float(fetch_data['Forest area (% of land area)'][(fetch_data['Country']=='United Kingdom') & (fetch_data['Year']==year)].to_string(index=False)))

for year in years_choosen:
    data12.append(float(fetch_data['Forest area (% of land area)'][(fetch_data['Country']=='United States') & (fetch_data['Year']==year)].to_string(index=False)))
...
plt.title('Forest area across the world (1990 - 2020)')
